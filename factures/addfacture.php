...
if(isset($_POST['submit'])){
  ...
  $rq = $bdd -> prepare("INSERT INTO factures ( datefacture, dateprestation, numfacture, idsociete)
    ...
    header('location:addfacture.php'); //permet de rafraichir la page en y renvoyant automatiquement
}
?>
        ...
        <table border='1'>
        	...
        	{ ?>
              ...
              <td><?= $donnees['dateprestation']?></td>
          		<td><a href="detailsfact.php?detaillefact=<?= $donnees['idfactures']?>"><?= $donnees['numfacture']?></a></td>
